...
public class EstabelecimentosServlet extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	...
	(EstabelecimentosService) req.getSession()
	.getAttribute("estabelecimentosService");

      HistoricoPesquisasService historicoService = 
	(HistoricoPesquisasService) req.getSession()
	...
	req.getRequestDispatcher("estabelecimentos.jsp");
